                           ...
                           <!-- <ul class="nav nav-tabs" id="myTab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-1">
                                  ...
                                  <form method="post"  action="<?=base_url();?>profile/result"  >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-map-marker input-icon"></i>
                                                            ...
                                                            <input  class="form-control" type="text" id="txtFrom" name="pick_up_location" placeholder="City, Airport" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-map-marker input-icon"></i>
                                                    ...
                                                    <div class="col-md-4">
                                                            ...
                                                            <div class="form-group form-group-lg form-group-select-plus">
                                                                    ...
                                                                    <select class="form-control hidden" name="seat">
                                             ...
                                             <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-calendar input-icon input-icon-highlight"></i>
														...
														<div class="col-md-5">
															...
															<div class="radio-inline radio-small">
                                                                <label class="white">
                                                                    <input class="i-radio" type="radio" name="myRadiolist vehicle_mode" value="2" />2 Wheeler</label>
                                                            </div>
                                                            <div class="radio-inline radio-small">
                                                                <label class="white">
                                                                    <input class="i-radio" type="radio" name="myRadiolist vehicle_mode" value="3" />3 Wheeler</label>
                                                            </div>
                                                            <div class="radio-inline radio-small">
                                                                <label class="white">
                                                                    <input class="i-radio" type="radio" name="myRadiolist vehicle_mode" value="4" />4 Wheeler</label>
                                                            </div>
														 </div>		 
