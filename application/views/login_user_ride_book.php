        ...
        <div class="container">
                            <div class="row row-wrap" data-gutter="60"> 
                                <div class="col-md-4">
                                    ...
                                    <form  method="post" action="<?=base_url();?>index.php/home/login_user_ride_check" >
							           <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon input-icon-show"></i>
										...
										<input type="hidden" value="<?=(!empty($demo_data[0]->offer_ride_id))?$demo_data[0]->offer_ride_id:''?>" name="offer_ride_id">
										<input type="hidden" value="<?=(!empty($demo_data[0]->frequency))?$demo_data[0]->frequency:''?>" name="frequency">
										<input   class="typeahead form-control" placeholder="City, Airport" type="hidden" name="pick_up_location" value="<?=(!empty($demo_data[0]->pick_up_location))?$demo_data[0]->pick_up_location:''?>"/>
										<input class="typeahead form-control" name="drop_off_location" placeholder="City, Airport" type="hidden" value="<?=(!empty($demo_data[0]->drop_off_location))?$demo_data[0]->drop_off_location:''?>"/>
										<input class="form-control" name="date" type="hidden" 
										value="<?=(!empty($demo_data[0]->date))?$demo_data[0]->date:''?>"/>
										<input class="time-pick form-control" type="hidden" value="<?=(!empty($demo_data[0]->time))?$demo_data[0]->time:''?>" name="time"/>
										<input type="hidden" value="<?=(!empty($demo_data[0]->seats_booked))?$demo_data[0]->seats_booked:''?>" name="seats_booked">
